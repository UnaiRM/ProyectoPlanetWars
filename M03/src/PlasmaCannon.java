...
public class PlasmaCannon extends Ship {
	...
	public void setArmorAndDamage(int attackLevel, int defenseLevel) {
		int armor = (Variables.ARMOR_PLASMACANNON) + (defenseLevel * Variables.PLUS_ARMOR_PLASMACANNON_BY_TECHNOLOGY)*1000/100;
		int baseDamage = (Variables.BASE_DAMAGE_PLASMACANNON) + (attackLevel * Variables.PLUS_ATTACK_PLASMACANNON_BY_TECHNOLOGY)*1000/100;
