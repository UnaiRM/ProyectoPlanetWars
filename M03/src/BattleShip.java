...
public class BattleShip extends Ship {
	...
	public void setArmorAndDamage(int attackLevel, int defenseLevel) {
		int armor = (Variables.ARMOR_BATTLESHIP) + (defenseLevel * Variables.PLUS_ARMOR_BATTLESHIP_BY_TECHNOLOGY)*1000/100;
		int baseDamage = (Variables.BASE_DAMAGE_BATTLESHIP) + (attackLevel * Variables.PLUS_ATTACK_BATTLESHIP_BY_TECHNOLOGY)*1000/100;
