...
public class HeavyHunter extends Ship {
	...
	public void setArmorAndDamage(int attackLevel, int defenseLevel) {
		int armor = (Variables.ARMOR_HEAVYHUNTER) + (defenseLevel * Variables.PLUS_ARMOR_HEAVYHUNTER_BY_TECHNOLOGY)*1000/100;
		int baseDamage = (Variables.BASE_DAMAGE_HEAVYHUNTER) + (attackLevel * Variables.PLUS_ATTACK_HEAVYHUNTER_BY_TECHNOLOGY)*1000/100;
